...
if __name__ == '__main__':
    ...
    print(RegDecode.to_str(0x21))
    print(RegDecode.to_str([0x00, 0x21]))
    print(RegDecode.to_str('blah'))
    print(RegDecode.to_str([0x00, 'blubb', 0x21]))

    print();
    print(RegDecode.decode(0x26, 0xa5))
    print()
